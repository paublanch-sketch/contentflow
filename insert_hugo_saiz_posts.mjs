...
const CLIENT_ID = 'hugo-saiz-salamanca';
...
🌐 https://pinturasmuse.com/`,
  ...
  },
  {
    ...
    post_number: 8,
    platform: 'LI',
    headline_visual: 'Single image — Pieza industrial de gran tamaño (estructura metálica de más de 5m) en el interior del taller. Escala impactante.',
...
En Pinturas Muse hemos desarrollado una solución integral para este tipo de equipos:
...
El resultado: una máquina que mantiene su aspecto profesional incluso después de años de uso continuado.
...
🌐 https://pinturasmuse.com/`,
  ...
  },
  {
    ...
    post_number: 11,
    platform: 'LI',
    headline_visual: 'Single image — Collage histórico: foto antigua del taller combinada con foto actual moderna. Trayectoria 30 años. REQUIERE INTEGRACIÓN DE LOGO',
...
🌐 https://pinturasmuse.com/`,
  ...
  },
  {
    ...
    post_number: 12,
    platform: 'LI',
    headline_visual: 'Single image — Equipo técnico de Pinturas Muse en el taller con EPI, posando de forma profesional y cercana. REQUIERE INTEGRACIÓN DE LOGO',
...
async function run() {
  ...
  console.log('\n✅ Listo. Recarga ContentFlow para ver los posts de HUGO SAIZ SALAMANCA.');
}
